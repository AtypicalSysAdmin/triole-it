        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-5 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:border-purple-500/40 transition">
                ...
                <div>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider font-semibold mb-0.5">Email Support</p>
                  <a href="mailto:admin@triole-it.com" className="text-base font-semibold text-white hover:text-purple-400 transition">
                    admin@triole-it.com
                  </a>
                </div>
              </div>

              <div className="flex items-center gap-5 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:border-pink-500/40 transition">
                ...
                <div>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider font-semibold mb-0.5">Direct Message / Updates</p>
                  <a href="https://instagram.com/triole_it" target="_blank" rel="noopener noreferrer" className="text-base font-semibold text-white hover:text-pink-400 transition">
                    @triole_it
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-5 p-4 rounded-xl bg-zinc-900/60 border border-zinc-800 hover:border-purple-500/40 transition">
                ...
                <div>
                  <p className="text-xs text-zinc-400 uppercase tracking-wider font-semibold mb-0.5">Primary Service Region</p>
                  <p className="text-base font-semibold text-white">Vancouver, BC &amp; Surrounding Areas</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-8 glass-card p-6 text-center border border-zinc-800/80 flex items-center justify-center gap-3"
          >
            <Clock size={18} className="text-purple-400 shrink-0" />
            <p className="text-xs text-zinc-400">
              We typically respond to inquiries within <span className="text-purple-300 font-semibold">2–4 business hours</span>
            </p>
          </motion.div>
        </div>
      </div>
