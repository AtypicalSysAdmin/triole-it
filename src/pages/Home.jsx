      ...
      <section className="relative pt-16 pb-24 lg:pt-24 lg:pb-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-center">
            ...
            >
              <div className="inline-flex items-center gap-2.5 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-2 text-sm font-semibold uppercase tracking-wider text-purple-300 shadow-[0_0_15px_rgba(168,85,247,0.2)] mb-6">
              ...
              <p className="mt-6 text-xl leading-relaxed text-zinc-300 max-w-2xl">
              ...
              <div className="mt-10 flex flex-wrap items-center gap-6 text-sm font-medium text-zinc-300">
            ...
            >
              <div className="relative z-10 glass-card rounded-2xl p-6 sm:p-8 neon-border">
                <div className="flex items-center justify-between border-b border-zinc-800 pb-4 mb-6">
                  ...
                  <span className="rounded-full bg-purple-500/20 px-3 py-1 text-sm font-semibold text-purple-300 border border-purple-500/30">
                    Available Today
                  </span>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-5 transition hover:border-purple-500/50">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-purple-500/10 border border-purple-500/20 text-purple-400 mb-3">
                      <Zap size={24} />
                    </div>
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-5 transition hover:border-pink-500/50">
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500/10 border border-pink-500/20 text-pink-400 mb-3">
                      <Smile size={24} />
                    </div>
                ...
                <div className="mt-6 rounded-xl border border-purple-500/20 bg-purple-950/20 p-4 sm:p-5 flex items-center justify-between gap-3">
                  <div>
                    <p className="text-sm font-semibold text-purple-300">Need Hardware or Workspace Gear?</p>
                    <p className="text-sm text-zinc-300">Shop curated tech at Triole Store</p>
                  </div>
                  <a
                    href="https://store.triole-it.com"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-purple-300 hover:text-white transition shrink-0"
                  >
      ...
      <section className="relative border-y border-zinc-800/80 bg-zinc-900/30 backdrop-blur-md">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-16 sm:grid-cols-3 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-2xl p-7 border border-zinc-800/80 hover:border-purple-500/40 transition">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-purple-500/10 border border-purple-500/20 text-purple-400">
              <Laptop size={28} />
            </div>
            <h3 className="mt-5 text-xl font-bold text-white">Computer &amp; Laptop Repairs</h3>
            <p className="mt-2.5 text-base text-zinc-300 leading-relaxed">
          ...
          <div className="glass-card rounded-2xl p-7 border border-zinc-800/80 hover:border-pink-500/40 transition">
            ...
            <h3 className="mt-5 text-xl font-bold text-white">Wi-Fi &amp; Network Setup</h3>
            <p className="mt-2.5 text-base text-zinc-300 leading-relaxed">
          ...
          <div className="glass-card rounded-2xl p-7 border border-zinc-800/80 hover:border-purple-500/40 transition">
            ...
            <h3 className="mt-5 text-xl font-bold text-white">Affordable &amp; Upfront</h3>
            <p className="mt-2.5 text-base text-zinc-300 leading-relaxed">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {services.map((service, i) => (
              ...
              >
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-zinc-800/80 border border-zinc-700/60 group-hover:border-purple-500/50 group-hover:scale-110 transition duration-300 mb-6">
                  {service.icon}
                </div>
                ...
                <Link
                  to="/services"
                  className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-purple-400 group-hover:text-purple-300"
                >
          ...
          <div className="mt-16 rounded-2xl border border-purple-500/30 bg-gradient-to-r from-purple-950/40 via-zinc-900/60 to-pink-950/40 p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-6 neon-border">
            <div>
              ...
              <p className="text-base text-zinc-300 mt-2 max-w-xl leading-relaxed">
